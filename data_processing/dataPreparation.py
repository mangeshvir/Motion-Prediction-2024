...
class dataPrepare:
    ...
    def data_stacking(self):
        ...
        # print("data_stacking_input")
        # print(self.data_stacking_input)
        # print("ppp")
        # print(self.data_stacking_input['trackId'][1:])
        new_array = \
        np.where(np.roll(self.data_stacking_input['trackId'][1:], 1) != self.data_stacking_input['trackId'][1:])[0]

        # print("where")
        # print(np.where(np.roll(self.data_stacking_input['trackId'][1:], 1) != self.data_stacking_input['trackId'][1:]))
        # print("new_array")
        # print(new_array)

        for x in tqdm(range(self.track_id_range)):  # loop through the selected number of trackIds
